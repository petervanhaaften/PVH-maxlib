...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 500.5, 397.0, 164.0, 20.0 ],
					"style" : "",
					"text" : "function4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.5, 397.0, 164.0, 20.0 ],
					"style" : "",
					"text" : "function3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 500.5, 225.0, 164.0, 20.0 ],
					"style" : "",
					"text" : "function2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.5, 225.0, 164.0, 20.0 ],
					"style" : "",
					"text" : "function1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 500.5, 415.0, 190.0, 132.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 296.5, 415.0, 190.0, 132.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 500.5, 240.0, 190.0, 132.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "pvh.quadfunctiongen.view~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.5, 207.0, 150.0, 210.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 296.5, 141.5, 43.0, 22.0 ],
					"style" : "",
					"text" : "del 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.5, 419.0, 75.0, 20.0 ],
					"style" : "",
					"text" : "by pvh 2017"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.0, 28.5, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 296.5, 11.5, 37.0, 37.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.5, 113.5, 41.0, 22.0 ],
					"style" : "",
					"text" : "r start"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.5, 57.5, 43.0, 22.0 ],
					"style" : "",
					"text" : "s start"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 180.0, 242.0, 22.0 ],
									"style" : "",
									"text" : "file/path pvh.quadfunctiongen~.maxhelpcue"
								}
...
,
					"patching_rect" : [ 344.5, 57.5, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					"annotation" : "quad AD variable shape function generator",
					...
					"patching_rect" : [ 296.5, 197.0, 217.0, 22.0 ],
					"style" : "",
					"text" : "pvh.quadfunctiongen.model~ function1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 296.5, 171.5, 65.0, 22.0 ],
					"style" : "",
					"text" : "metro 250"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 355.5, 228.0, 510.0, 228.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "pvh.quadfunctiongen.model~.maxpat",
				"bootpath" : "~/src/max/PVH-maxlib/pvh.quadfunction~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
